...
// import 'package:healther_mobile_app/screen/symptoms%20&%20diagnosis_screen.dart';
...
//   List<String> symptoms = ['Fever', 'Cough', 'Headache'];
//   List<String> diagnosis = ['Cold', 'Flu', 'Pneumonia'];
...
//                 ),
//                 onPressed: () {
//                   if (_selectedSx.contains("Seizures")) {
//                     Navigator.push(context, MaterialPageRoute(builder: (context) {
//                       return  SymptomsDiagnosisScreen(  selectedSx: _selectedSx,
//                         selectedDx: _selectedDx,);
//                     }));
//                   } else {
//                     _showSeizuresRequiredMessage();
//                   }
//                 },
//                 child: const Text(
//                   AppText.save,
...
//                       onTap: () {
//                         Navigator.push(context, MaterialPageRoute(builder: (context) => const SxAndDxScreen()));
//                       },
//                       child: const Icon(Icons.search, color: AppColors.blackColor),
//                     ),
//                   ),
//                 ),
//               ),
...
//                     child: const Center(child: Text("Sx", style: TextStyle(color: Colors.white))),
//                   ),
...
//                     child: const Center(child: Text("Dx", style: TextStyle(color: Colors.white))),
//                   ),
//                 ],
//               ),
//             ),
...
//                         ),
//                         color: (type == "Sx" && isSelectedSx) || (type == "Dx" && isSelectedDx)
//                             ? const Color(0xFFFEFEFE)
//                             : Colors.transparent,
//                       ),
//                       child: (type == "Sx" && isSelectedSx) || (type == "Dx" && isSelectedDx)
//                           ? const Icon(
//                         Icons.check,
//                         size: 16,
//                         color: Colors.black,
                ...
                child: Column(
                  children: _symptomsList
                      .map((symptom) => ListTile(
                                ...
                                Transform.scale(
                                  ...
                                  child: Checkbox(
                                    shape: ContinuousRectangleBorder(
                                        borderRadius: BorderRadius.circular(8)),
                                    value: _selectedDx.contains(symptom),
                                    ...
                                    onChanged: (bool? value) {
                                      setState(() {
                                        if (value == true) {
                                          _selectedDx.add(symptom);
                                        } else {
                                          _selectedDx.remove(symptom);
                                        }
                                      });
                                    },
                                  ),
                            ...
                            onTap: () {
                              setState(() {
                                if (_selectedDx.contains(symptom)) {
                                  _selectedDx.remove(symptom);
                                } else {
                                  _selectedDx.add(symptom);
                                }
                            ...
                            selected: _selectedDx.contains(symptom),
                          ))
                      .toList(),
                ),
              ),
                ...
                onPressed: () {
                  if (_selectedSx.length >= 3) {
                    Navigator.push(context,
                      ...
                      return SymptomsDiagnosisScreen(
                          selectedSx: _selectedSx, selectedDx: _selectedDx);
                    }));
                  } else {
